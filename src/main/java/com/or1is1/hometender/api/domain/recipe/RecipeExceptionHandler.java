...
public class RecipeExceptionHandler {
	...
	public CommonResponse<MemberIsExistsResponse> memberAlreadyExistsException(RecipeIsNotMineException ex) {
	...
	@ExceptionHandler
	@ResponseStatus(BAD_REQUEST)
	public CommonResponse<MemberIsExistsResponse> recipeIngredientIsEmptyException(RecipeIngredientIsEmptyException ex) {
